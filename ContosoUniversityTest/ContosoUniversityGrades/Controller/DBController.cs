...
namespace ContosoUniversityGrades.Controller
{
    public class DBController
    {
        ...
        {
            //Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\kingdom\Desktop\ContosoUniversityTest\ContosoUniversity\App_Data\School.mdf;Integrated Security=True;MultipleActiveResultSets=True
            // Open connection to DB
            String dataSource = @"(LocalDb)\MSSQLLocalDB";
            _currentPath = Environment.CurrentDirectory;
            String pathToDbFolder = String.Empty;
            if (_currentPath.Contains("ContosoUniversityGrades"))
            {
                pathToDbFolder = _currentPath.Remove(_currentPath.Length - (@"ContosoUniversityGrades\bin\Debug").Length) + @"ContosoUniversity\App_Data\";
            }
            else if (_currentPath.Contains("CUTests"))
            {
                pathToDbFolder = _currentPath.Remove(_currentPath.Length - (@"CUTests\bin\Debug").Length) + @"ContosoUniversity\App_Data\";
            }
            else
            {
                pathToDbFolder = _currentPath + @"\ContosoUniversity\App_Data\";
            }
